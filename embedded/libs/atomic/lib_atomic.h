...
__attribute__((always_inline)) inline void atomicXorU64(volatile uint64_t *ptr, uint64_t val)  { (void)__sync_xor_and_fetch(ptr, val); }
...
__attribute__((always_inline)) inline void atomicXorU32(volatile uint32_t *ptr, uint32_t val)  { (void)__sync_xor_and_fetch(ptr, val); }
...
#else // ifdef __GNUC__
__attribute__((always_inline)) inline void atomicAddU64(volatile uint64_t *ptr, uint64_t val)  { *ptr += val; }
__attribute__((always_inline)) inline void atomicSubU64(volatile uint64_t *ptr, uint64_t val)  { *ptr -= val; }
__attribute__((always_inline)) inline void atomicOrU64(volatile uint64_t *ptr, uint64_t val)   { *ptr |= val; }
__attribute__((always_inline)) inline void atomicXorU64(volatile uint64_t *ptr, uint64_t val)  { *ptr ^= val; }
__attribute__((always_inline)) inline void atomicAndU64(volatile uint64_t *ptr, uint64_t val)  { *ptr &= val; }
__attribute__((always_inline)) inline void atomicNandU64(volatile uint64_t *ptr, uint64_t val) { ~(*ptr &= val); }

__attribute__((always_inline)) inline void atomicAddU32(volatile uint32_t *ptr, uint32_t val)  { *ptr += val; }
__attribute__((always_inline)) inline void atomicSubU32(volatile uint32_t *ptr, uint32_t val)  { *ptr -= val; }
__attribute__((always_inline)) inline void atomicOrU32(volatile uint32_t *ptr, uint32_t val)   { *ptr |= val; }
__attribute__((always_inline)) inline void atomicXorU32(volatile uint32_t *ptr, uint32_t val)  { *ptr ^= val; }
__attribute__((always_inline)) inline void atomicAndU32(volatile uint32_t *ptr, uint32_t val)  { *ptr &= val; }
__attribute__((always_inline)) inline void atomicNandU32(volatile uint32_t *ptr, uint32_t val) { ~(*ptr &= val); }
