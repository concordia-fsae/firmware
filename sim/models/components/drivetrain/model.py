...
class DrivetrainModel(ComponentRig):
    ...
    def rust_datapath_route_abi(self, path: DataPath) -> NativeRouteEndpoint | None:
        ...
        if path in (self.mechanical_torque_output_channel, self.current_draw_output_channel):
    ...
    def _register_native_drivetrain(self) -> None:
        ...
        register = self._bind_native_model_symbol(
            ...
            [ctypes.c_uint32, ctypes.c_uint32, ctypes.c_uint32, ctypes.c_uint32, ctypes.c_uint32, ctypes.c_float, ctypes.c_float, ctypes.c_float, ctypes.c_float, ctypes.c_uint64],
        )
