...
use super::registry::{InterfaceRoute};
use super::io;
use super::scheduler;

pub(super) type ClusterSpiCountFn = unsafe extern "C" fn(i32) -> u32;
pub(super) type ClusterSpiRecvManyFn = unsafe extern "C" fn(i32, *mut SpiTransaction, u32) -> u32;
pub(super) type ClusterSpiSendManyFn = unsafe extern "C" fn(*const SpiTransaction, u32) -> u32;
...
pub extern "C" fn rig_cluster_add_spi_route(
    ...
    with_runtime(|runtime| {
        runtime.register_route(InterfaceRoute::Spi(ClusterSpiRoute {
            source_node,
            device,
            source_count,
            source_recv_many,
...
#[unsafe(no_mangle)]
pub extern "C" fn rig_model_spi_send(transaction: *const SpiTransaction) -> bool {
    if transaction.is_null() {
        return false;
    }
    push_input(unsafe { *transaction })
...
#[unsafe(no_mangle)]
pub extern "C" fn rig_model_spi_recv(device: i32, transaction: *mut SpiTransaction) -> bool {
    if transaction.is_null() {
        return false;
    }
    match pop_output(device) {
