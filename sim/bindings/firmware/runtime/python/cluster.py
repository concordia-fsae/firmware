...
from .peripheral import PeripheralInterface, require_peripheral_binding
...
from sim.bindings.firmware.spi.spi import SpiTransaction
from sim.bindings.firmware.timer.timer import TimerChannelEvent
