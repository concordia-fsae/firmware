...
def _carputer_deploy_targets_manifest_impl(ctx: AnalysisContext) -> list[Provider]:
    ...
    for asset in firmware_assets:
        ...
        script_lines.extend([
            ...
            '    requires_manual_recovery: {}'.format("true" if asset.node in ctx.attrs.uds_requires_manual_recovery else "false"),
            '    artifact:',
...
carputer_deploy_targets_manifest = rule(
    ...
    attrs = {
        ...
        "uds_requires_manual_recovery": attrs.list(attrs.string(), default = []),
...
def carputer_platform_targets(
    ...
    carputer_deploy_targets_manifest(
        ...
        uds_requires_manual_recovery = uds_requires_manual_recovery,
