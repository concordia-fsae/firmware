...
static void cooling10Hz_PRD(void)
{
    ...
    drv_vn9008_setDuty(DRV_VN9008_CHANNEL_PUMP, ((isHV || isRun || testPump) && !faultPump) ? 1.0f : 0.0f);
    drv_vn9008_setDuty(DRV_VN9008_CHANNEL_FAN, ((isRun || testFan) && !faultFan) ? 1.0f : 0.0f);
}
