...
typedef enum
{
    ...
    HW_GPIO_DIG_SPARE4,
    HW_GPIO_LED,
    HW_GPIO_ADC_AIN_SPARE1, //ADC ADDED FOR THE NEXT FEW
    HW_GPIO_ADC_AIN_SPARE2, 
    HW_GPIO_ADC_AIN_SPARE3, 
    HW_GPIO_ADC_AIN_SPARE4, 
    HW_GPIO_ADC_APPS_P1,
    HW_GPIO_ADC_APPS_P2,
    HW_GPIO_ADC_BR_POT,
    HW_GPIO_ADC_L_SHK_DISP,
    HW_GPIO_ADC_L_BR_TMP,
    HW_GPIO_ADC_R_SHK_DISP,
    HW_GPIO_ADC_R_BR_TMP,
    HW_GPIO_ADC_AIN_PU1,
    HW_GPIO_ADC_AIN_PU2,
    HW_GPIO_ADC_BR_PR,
    HW_GPIO_ADC_BOARD_TEMP_1, //WAS TEMP_1
    HW_GPIO_5V_FLT2,
    HW_GPIO_5V_EN2,
    HW_GPIO_5V_EN1,
    HW_GPIO_5V_FLT1,
    ...
    HW_GPIO_TSSI_R_EN,
    HW_GPIO_BR_LIGHT_EN,
    HW_GPIO_CAN1_RX = 0U, // WAS HW_GPIO_RXD1
