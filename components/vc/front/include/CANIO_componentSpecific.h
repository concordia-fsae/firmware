...
#define set_shockpotdispFL(m, b, n, s)                     set(m, b, n, s, shockpot_getDisplacement(SHOCKPOT_LEFT))
#define set_shockpotdispFR(m, b, n, s)                     set(m, b, n, s, shockpot_getDisplacement(SHOCKPOT_RIGHT))
...
#define set_gpsInvalidTime(m, b, n, s)                     set(m, b, n, s, app_gps_getValidTime() ? CAN_FAULTSTATUS_OK : CAN_FAULTSTATUS_FAULT)
#define set_gpsInvalidDate(m, b, n, s)                     set(m, b, n, s, app_gps_getValidDate() ? CAN_FAULTSTATUS_OK : CAN_FAULTSTATUS_FAULT)
#define set_gpsSatellites(m, b, n, s)                      set(m, b, n, s, app_gps_getNumSatellites())
#define set_gpsQualityIndicator(m, b, n, s)                set(m, b, n, s, app_gps_getQualityCAN())
...
#define set_paramTcTireModelLimit(m, b, n, s)              set(m, b, n, s, tc_isParamEnabled(PARAMSTATE_TC_TIRE_MODEL_LIMIT) ? CAN_DIGITALSTATUS_ON : CAN_DIGITALSTATUS_OFF)
#define set_paramTcMapping(m, b, n, s)                     set(m, b, n, s, tc_getMappingCAN())
#define set_paramTcKp(m, b, n, s)                          set(m, b, n, s, tc_getParamKp())
#define set_paramTcKi(m, b, n, s)                          set(m, b, n, s, tc_getParamKi())
#define set_paramTcKd(m, b, n, s)                          set(m, b, n, s, tc_getParamKd())
#define set_paramTcPidMax(m, b, n, s)                      set(m, b, n, s, tc_getParamPidMax())
#define set_paramTcILim(m, b, n, s)                        set(m, b, n, s, tc_getParamILim())
#define set_paramTcTLeak(m, b, n, s)                       set(m, b, n, s, tc_getParamTLeak())
