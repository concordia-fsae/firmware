...
#endif // if FEATURE_IS_ENABLED(FEATURE_VEHICLESPEED_LEADER)
...
#endif // if WHEELSPEED_FAULTS_ENABLED
...
#endif // if FEATURE_IS_ENABLED(FEATURE_VEHICLESPEED_LEADER) || FEATURE_IS_ENABLED(FEATURE_VEHICLESPEED_USEODOMETER)
