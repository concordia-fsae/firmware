...
#define set_maxDischargeModeled(m, b, n, s)            set(m, b, n, s, bm.dischargeLimit * -1 * BMS_CONFIGURED_PARALLEL_CELLS)
#define set_maxChargeModeled(m, b, n, s)               set(m, b, n, s, bm.chargeLimit * BMS_CONFIGURED_PARALLEL_CELLS)
...
#define set_tsmsChg(m, b, n, s)                        set(m, b, n, s, drv_userInput_buttonPressed(USERINPUT_SWITCH_TSMS) ? \
