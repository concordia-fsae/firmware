...
static void routine_charging(udsRoutineControlType_E routineControlType, uint8_t *payload, uint8_t payloadLengthBytes)
{
    UNUSED(payloadLengthBytes);
    UNUSED(payload);
...
void uds_cb_routineControl(udsRoutineControlType_E routineControlType, uint8_t *payload, uint8_t payloadLengthBytes)
{
    ...
    switch (routineId.u16)
    {
        ...
        case 0x0302:
            routine_charging(routineControlType, payload + 2U, payloadLengthBytes);
            break;
