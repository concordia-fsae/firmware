...
// SWIs
RTOS_swiHandle_T* CANTX_BUS_A_100Hz_swi;
RTOS_swiHandle_T* CANTX_BUS_A_10Hz_swi;
RTOS_swiHandle_T* CANTX_BUS_A_1Hz_swi;
...
void RTOS_createResources(void)
{
     ...
     * create SWI handles
     */
    CANTX_BUS_A_100Hz_swi = SWI_create(RTOS_SWI_PRI_0, &CANTX_BUS_A_100Hz_SWI);
    CANTX_BUS_A_10Hz_swi = SWI_create(RTOS_SWI_PRI_1, &CANTX_BUS_A_10Hz_SWI);
    CANTX_BUS_A_1Hz_swi = SWI_create(RTOS_SWI_PRI_2, &CANTX_BUS_A_1Hz_SWI);
