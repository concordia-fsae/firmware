...
// TODO: Improve this to use the enum field
...
// TODO: Change this and yamcan to `balancingTemp`
#define set_boardTemp0(m, b, n, s)               set(m,b,n,s, drv_tempSensors_getChannelTemperatureDegC(DRV_TEMPSENSORS_CHANNEL_BALANCING1))
#define set_boardTemp1(m, b, n, s)               set(m,b,n,s, drv_tempSensors_getChannelTemperatureDegC(DRV_TEMPSENSORS_CHANNEL_BALANCING2))
#if APP_VARIANT_ID == 1U
#define set_boardTemp(m, b, n, s)               set(m,b,n,s, drv_tempSensors_getChannelTemperatureDegC(DRV_TEMPSENSORS_CHANNEL_BOARD))
#endif
