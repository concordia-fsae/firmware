...
#define set_balancingTemp0(m, b, n, s)               set(m,b,n,s, drv_tempSensors_getChannelTemperatureDegC(DRV_TEMPSENSORS_CHANNEL_BALANCING1))
#define set_balancingTemp1(m, b, n, s)               set(m,b,n,s, drv_tempSensors_getChannelTemperatureDegC(DRV_TEMPSENSORS_CHANNEL_BALANCING2))
