...
HW_StatusTypeDef_E HW_ADC_init_componentSpecific(void)
{
    ...
    sConfig.Channel      = ADC_BANK1_CHANNEL_AIN2;
    ...
    sConfig.Channel      = ADC_BANK1_CHANNEL_AIN4;
    ...
    sConfig.Channel      = ADC_BANK1_CHANNEL_AIN6;
    ...
    // Configure Regular Channels
    sConfig.Channel      = ADC_BANK2_CHANNEL_AIN1;
    sConfig.Rank         = ADC_REGULAR_RANK_1;
    sConfig.SamplingTime = ADC_SAMPLETIME_13CYCLES_5;
    ...
    sConfig.Channel      = ADC_BANK2_CHANNEL_AIN3;
    sConfig.Rank         = ADC_REGULAR_RANK_2;
    sConfig.SamplingTime = ADC_SAMPLETIME_13CYCLES_5;
    if (HAL_ADC_ConfigChannel(&hadc2, &sConfig) != HAL_OK)
    {
    ...
    sConfig.Channel      = ADC_BANK2_CHANNEL_AIN5;
    sConfig.Rank         = ADC_REGULAR_RANK_3;
    sConfig.SamplingTime = ADC_SAMPLETIME_13CYCLES_5;
    if (HAL_ADC_ConfigChannel(&hadc2, &sConfig) != HAL_OK)
    {
    ...
    sConfig.Channel      = ADC_BANK2_CHANNEL_AIN7;
    sConfig.Rank         = ADC_REGULAR_RANK_4;
    sConfig.SamplingTime = ADC_SAMPLETIME_13CYCLES_5;
    if (HAL_ADC_ConfigChannel(&hadc2, &sConfig) != HAL_OK)
    {
